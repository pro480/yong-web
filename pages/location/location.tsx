    ...
    return (
        <div className='flex flex-col gap-y-12 md:space-y-8'>
            ...
            <div className='flex flex-col items-center gap-y-6  md:flex-row'>
                ...
                <div className='flex w-72 flex-col space-y-5 font-bold sm:w-3/5'>
            ...
            <div className='flex flex-col font-bold sm:space-y-8'>
                <div className='mb-5 flex space-x-5 border-b-8 pb-3 text-PRIMARY_COLOR-700'>
                    <TruckIcon className='bg h-full w-10' />
                    <a className='mb-5 text-3xl md:text-4xl'>대중교통안내</a>
                </div>
                ...
                <div className='flex w-full flex-col space-y-14'>
                    ...
                    <div className='flex h-fit w-full flex-col items-center justify-center space-x-16 xs:items-center sm:flex-row'>
                        ...
                        <div className='flex w-full flex-col space-y-10 sm:w-4/5'>
                            ...
                            <LocationBox
                                range={"시내"}
                                howToCome={"5, 5-1, 8, 9, 13, 27, 46, 111-2"}
                            />
                            <LocationBox
                                range={"시외"}
                                howToCome={"3001(광명역)"}
