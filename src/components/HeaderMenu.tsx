        ...
        <div className="h-full">
            ...
            <div className="flex h-full items-center text-xl font-semibold ">
                ...
                >
                    ...
                    <span
                        className="absolute bottom-0 left-1/2 flex h-1.5 w-0 -translate-x-1/2 content-center justify-center bg-PRIMARY_COLOR group-hover:w-12 group-hover:transition-all"></span>
                </div>
            </div>
            {/*아래부터 드랍다운  메뉴*/}
