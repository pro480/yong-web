      ...
      subTitle: [
        ...
        },
        {
          ...
          subMenu: [
            ...
            { title: "중장기 발전 목표", href: "/info/vision/goals" },
          ],
          href: "/info/vision",
        },
        {
        ...
        },
        {
          title: "센터 조직(조직도)",
          subMenu: [
            { title: "연구협력 네트워크", href: "/info/organization/network" },
            { title: "연구 자문단", href: "/info/organization/research" },
            { title: "연구 윤리 자문단", href: "/info/organization/ethics" },
            { title: "데이터 분석팀", href: "/info/organization/analytics" },
          ],
