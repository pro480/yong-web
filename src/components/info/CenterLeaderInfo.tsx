        ...
        <>
            ...
            <div className="relative flex aspect-[2/1] w-full flex-col justify-end">
                ...
                <div className='flex h-[50%]'>
                    {/*사다리꼴의 직사각형 부분 및 내용 */}
                    <div className='flex h-full w-3/5 items-center bg-gradient-to-l from-PRIMARY_COLOR-500 to-PRIMARY_COLOR-400 pl-1 text-[2px] text-white xs:pl-3 xs:text-xs  md:pl-6 md:text-base lg:pl-9 lg:text-lg desktop:pl-12 desktop:text-xl/5 xs:pl-3 xs:text-xs  md:pl-6 md:text-base lg:pl-9 lg:text-lg desktop:pl-12 desktop:text-xl'>
