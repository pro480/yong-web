        ...
        <div ref={cardRef} className='flex h-full  w-full gap-x-8'>
            ...
            <div className='flex h-full w-3/4 flex-col gap-y-3 py-2'>
                ...
                >
                    ...
                    > */}
                    <h1
                        className={`font-semibold text-PRIMARY_COLOR-500`}
                    >
                        {member.name}
                    </h1>
                    {member.major && (
                        ...
                        // </div>
                        <div
                            className={`flex text-PRIMARY_COLOR-500 `}
                        >
                            {member.major}
                        </div>
                    )}
                ...
                <div className='flex h-full w-full flex-wrap text-sm'>
                    ...
                    > */}
                    <div
                        className={`my-2 flex h-fit w-full items-center justify-between text-PRIMARY_COLOR-500`}
                    >
...
export default GraduateNameCard;
